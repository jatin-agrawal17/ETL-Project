...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->Pipeline:
        logging.info("entered get data transormer object method of transformation class")
        try:
            imputer:KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)  #for key value pair
            logging.info(f"Initilize knn imputer {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
